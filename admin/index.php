...
<head>
  ...
  <title>Intersolusi Cipta Softindo</title>
...
<!--           <a href="#"><i class="fa fa-circle text-success"></i> Online</a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?= ($hal=='beranda' || $hal=='')?'class="active"':'' ?>><a href="index.php"><i class="fa fa-home"></i> <span>Home</span></a></li>

        <li <?= ($hal=='karyawan')?'class="active"':'' ?>><a href="?hal=karyawan"><i class="fa fa-user"></i> <span>Karyawan</span></a></li>
